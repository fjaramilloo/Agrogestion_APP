                        ...
                        >
                            <div style={{ padding: '20px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                                <div style={{ fontSize: '1.1rem', fontWeight: 'bold', color: 'white', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                                    ...
                                    {compra.titulo.toUpperCase()}
                                </div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-muted)', fontSize: '0.9rem' }}>
                                    <Calendar size={14} /> Fecha de compra: {formatFecha(compra.fechaCompra)}
                                </div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '4px' }}>
                                    <Users size={14} /> Proveedor: {compra.proveedor}
                                </div>
                            </div>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', padding: '20px', gap: '16px', backgroundColor: 'rgba(0,0,0,0.1)' }}>
                                <div style={{ textAlign: 'center' }}>
                                    ...
                                    <div style={{ fontSize: '1.3rem', fontWeight: 'bold', color: 'white' }}>{compra.animalesCount}</div>
                                </div>
                                <div style={{ textAlign: 'center', borderLeft: '1px solid rgba(255,255,255,0.1)', borderRight: '1px solid rgba(255,255,255,0.1)' }}>
                                    ...
                                    <div style={{ fontSize: '1.3rem', fontWeight: 'bold', color: 'white' }}>{Math.round(compra.pesoPromedioIngreso)}<span style={{ fontSize: '0.8rem', opacity: 0.6 }}>kg</span></div>
                                </div>
                                <div style={{ textAlign: 'center' }}>
                                    <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem', textTransform: 'uppercase', marginBottom: '4px' }}>GMP Lote</div>
                                    <div style={{ fontSize: '1.3rem', fontWeight: 'bold', color: compra.gmpPromedio > umbralAlto ? 'var(--success)' : (compra.gmpPromedio > umbralMedio ? 'var(--warning)' : (compra.gmpPromedio > 0 ? 'var(--error)' : 'white')) }}>{compra.gmpPromedio > 0 ? compra.gmpPromedio.toFixed(1) : '-'}<span style={{ fontSize: '0.8rem', opacity: 0.6 }}>kg</span></div>
                                </div>
                            </div>
