            ...
            <div className="report-simple-container">
                ...
                <div className="rs-header">
                    ...
                    <div className="rs-subtitle">
                        ...
                        <strong>Fecha de ingreso:</strong> {format(new Date(fechaCompra + 'T12:00:00'), 'dd/MM/yyyy')}
                    </div>
                </div>
                    ...
                    <tbody>
                        {animales.map((a, i) => (
                            <tr key={i}>
                                ...
                                <td style={{ textAlign: 'center' }}>{parseFloat(a.peso_ingreso.toString()).toFixed(1)}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
